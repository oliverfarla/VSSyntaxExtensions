...
namespace VSSyntaxExtensions
{
    ...
    internal sealed class ExpandSelection
    {
        ...
        private ExpandSelection(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        {
            // Switch to the main thread - the call to AddCommand in ExpandSelection's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new ExpandSelection(package, commandService);
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            Helpers.GrowShrinkSelection(textView, null, false, true);
