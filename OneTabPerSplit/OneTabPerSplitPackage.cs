...
namespace OneTabPerSplit
{
    ...
    [Guid(OneTabPerSplitPackage.PackageGuidString)]
    public sealed class OneTabPerSplitPackage : AsyncPackage
    {
        /// <summary>
        /// OneTabPerSplitPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "05d006d5-eaeb-4a31-befb-d0971f03e02b";
